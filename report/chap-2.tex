...
\subsection{Background on feature-based learning}
A feature value maps a trajectory onto a scalar and encapsulates a comfort criteria. The higher the scalar value the more discomfort is experienced by the driver. An example of a that measures the amount of accelerations in a maneuver is given by equation \ref{eq:3}.
